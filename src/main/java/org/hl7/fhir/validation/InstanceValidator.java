...
import org.hl7.fhir.model.Choice;
...
import org.hl7.fhir.model.Profile.BindingConformance;
import org.hl7.fhir.model.Profile.ElementComponent;
import org.hl7.fhir.model.Profile.ElementDefinitionConstraintComponent;
import org.hl7.fhir.model.Profile.ProfileBindingComponent;
import org.hl7.fhir.model.Profile.ProfileStructureComponent;
import org.hl7.fhir.model.Profile.TypeRefComponent;
...
import org.hl7.fhir.model.Type;
import org.hl7.fhir.model.Uri;
import org.hl7.fhir.model.ValueSet;
import org.hl7.fhir.model.ValueSet.ValueSetDefineConceptComponent;
import org.hl7.fhir.model.ValueSet.ValueSetExpansionContainsComponent;
import org.hl7.fhir.utilities.Utilities;
import org.hl7.fhir.utilities.valueset.ValueSetExpansionCache;
import org.hl7.fhir.utilities.xml.XMLUtil;
import org.hl7.fhir.validation.ValidationMessage.Source;
...
//		}
	...
	private void checkFixedValue(List<ValidationMessage> errors, String path, Element focus, org.hl7.fhir.model.Element fixed, String propName) {
		if (fixed == null && focus == null)
	  	...
	  	rule(errors, "value", path, false, "Mising element "+propName);
			...
			String value = focus.getAttribute("value");
			if (fixed instanceof org.hl7.fhir.model.Boolean)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Boolean) fixed).getStringValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Boolean) fixed).getStringValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Integer)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Integer) fixed).getStringValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Integer) fixed).getStringValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Decimal)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Decimal) fixed).getStringValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Decimal) fixed).getStringValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Base64Binary)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Base64Binary) fixed).getStringValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Base64Binary) fixed).getStringValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Instant)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Instant) fixed).getStringValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Instant) fixed).getStringValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.String_)
				rule(errors, "value", path, check(((org.hl7.fhir.model.String_) fixed).getValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.String_) fixed).getValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Uri)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Uri) fixed).getValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Uri) fixed).getValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Date)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Date) fixed).getValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Date) fixed).getValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.DateTime)
				rule(errors, "value", path, check(((org.hl7.fhir.model.DateTime) fixed).getValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.DateTime) fixed).getValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Oid)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Oid) fixed).getValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Oid) fixed).getValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Uuid)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Uuid) fixed).getValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Uuid) fixed).getValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Code)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Code) fixed).getValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Code) fixed).getValue()+"'");
			else if (fixed instanceof org.hl7.fhir.model.Id)
				rule(errors, "value", path, check(((org.hl7.fhir.model.Id) fixed).getValue(), value), "Value is '"+value+"' but must be '"+((org.hl7.fhir.model.Id) fixed).getValue()+"'");
